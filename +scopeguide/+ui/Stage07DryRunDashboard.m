classdef Stage07DryRunDashboard < handle
    ...
    methods
        ...
        function updateFromSnapshot(obj, snapshot)
            ...
            if obj.PhysicalMotionMode
                ...
                titleText = sprintf([ ...
                    'ScopeGuide 3-DOF DRAG | DOF=%s | %s | scale=%.2f | ' ...
    ...
    methods (Access = private)
        function createFigure(obj)
            if obj.PhysicalMotionMode
                figureName = 'ScopeGuide 3-DOF Admittance Drag';
                figureTag = 'ScopeGuide3DofAdmittanceDrag';
                initialTitle = ['三自由度导纳拖拽初始化：物理运动入口已打开，' ...
                    '请先确认急停和夹具'];
                padText = '鼠标按住运动使能';
            else
